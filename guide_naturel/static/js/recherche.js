document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderPaginationControls = (hasResults) => {
        ...
        const prevButton = createButton('Précédent', () => { hideInfobox(); fetchPaginatedResults(currentPage - 1); }, currentPage === 1, 'Page précédente', '../static/ressources/arrow/precedent.webp');
        const nextButton = createButton('Suivant', () => { hideInfobox(); fetchPaginatedResults(currentPage + 1); }, currentPage === totalPages, 'Page suivante', '../static/ressources/arrow/suivant.webp');
